...
<html lang="en">
  <head>
    ...
    <title>E-Mandi - Pakistan First Digital Mandi</title>
    <!-- Favicon -->
    <link
      rel="shortcut icon"
      type="image/x-icon"
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-2 col-sm-2">
                <div class="logo">
                  <a href="index.html" style="color: #000"><h1>E-Mandi</h1></a>
                </div>
              </div>
              <!-- Logo End -->
              <!-- Navigation Start -->
                ...
                <nav id="mobile-menu-active">
                  <ul class="menu-overflow">
                    <li>
                      ...
                      <ul>
                        <li>
                          <a href="login.html#">Home Organic</a>
                          <ul>
                        ...
                        <li>
                          <a href="login.html#">Home Cosmetic</a>
                          <ul>
                        ...
                        <li>
                          <a href="login.html#">Home Digital</a>
                          <ul>
                        ...
                        <li>
                          <a href="login.html#">Home Furniture</a>
                          <ul>
                        ...
                        <li>
                          <a href="login.html#">Home Medical</a>
                          <ul>
                    ...
                    <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="login.html#">Single Shop</a>
                          <ul>
                            <li>
            ...
            <div class="col-lg-7 col-md-12 ml-auto mr-auto">
              <div class="login-register-wrapper">
                <div class="login-register-tab-list nav">
                  <a class="active" data-toggle="tab" href="login - Copy.php#lg1">
                    <h4>login</h4>
                  </a>
                  <a data-toggle="tab" href="login - Copy.php#lg2">
                    <h4>register</h4>
                  </a>
                </div>
                      ...
                      <div class="login-register-form">
                        <form action="" method="post">
                          ...
                          <div class="button-box">
                            ...
                            <button type="submit" value="Login" name="submit"><span>Login</span></button>
                          </div>
                        </form>
						<?php  
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-lg-4">
                ...
                <div class="footer-logo">
                  <a href="index.html"
                    ><h2 style="color: #000">E-Mandi</h2></a>
                </div>
                <!-- footer logo -->
                <div class="about-footer">
                  <p class="text-info">
                    Powered By:</br>
					Logicial Society </br>
					<img src="assets/images/icons/logicial_society.png" width="100px" height="60px" alt="Logicial Society">
                  </p>
                  <div class="need-help">
                    <p class="phone-info">
                      NEED HELP?
              ...
              <div
                class="
                  col-md-6 col-lg-2
                  mt-res-md-50px mt-res-sx-30px mt-res-md-30px
                "
              >
                <div class="single-wedge">
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-6 col-lg-8">
                <img
                  class="payment-img"
                  src="assets/images/icons/payment(croped).png"
                  alt=""
                />
              </div>
            </div>
